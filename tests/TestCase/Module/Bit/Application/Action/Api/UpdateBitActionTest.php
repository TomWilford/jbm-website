...
use App\Module\Bit\Application\Service\UpdateBit;
use App\Module\Bit\Application\Validator\UpdateBitValidator;
...
#[CoversClass(UpdateBitAction::class)]
class UpdateBitActionTest extends TestCase
{
    use AppTestTrait;
    ...
    public function testUnexpectedError(): void
    {
        ...
        $mockCreator = $this->createMock(UpdateBit::class);
        ...
        $action = new UpdateBitAction($mockRenderer, $mockRepository, $mockValidator, $mockCreator);
