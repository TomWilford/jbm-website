...
#[CoversClass(UpdateThingAction::class)]
class UpdateThingActionTest extends TestCase
{
    use AppTestTrait;
    ...
    public function testUnexpectedError(): void
    {
        ...
        $mockCreator = $this->createMock(UpdateThing::class);
        ...
        $action = new UpdateThingAction($mockRenderer, $mockRepository, $mockValidator, $mockCreator);
